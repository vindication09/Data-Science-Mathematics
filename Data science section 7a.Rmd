...
One element that sets solving for trig equations apart from solving regular trig equations is the fact that unless specified, we will be solving for all relating angles within the unit circle. We will go through this concept on th whiteboard since it is something that is easier to grasp visually than conceptually. 
...
The sinx function is a repetative wave as shown in the above plot,howver we are going to go through the process of plotting it from scratch. This will help our understanding much more than seeing a computer generated plot.
