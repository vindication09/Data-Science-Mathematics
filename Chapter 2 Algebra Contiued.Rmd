...
Our solutions set for this system of equations is x=-4 and y=1. The next method we will look at is called elimination. This technique actually asks you to add or substract multiples of one equation to the other to eliminate variables as needed. This methos tends to be much faster especially as the number of equations and unknowns increases. 
